local is_windows = vim.fn.has("win32") == 1 or vim.fn.has("win64") == 1 or
                     os.getenv("WSL_DISTRO_NAME") == "archlinux"
...
return require("lazy").setup({
  ...
  {"mbbill/undotree", config = require("plugins.undotree")}, {
    ...
    version = '*',
    config = require("plugins.mini-files")
  }, -- LSP & Completion
  {
  ...
  -- Fzf-lua
  {
    ...
    dependencies = {
      "nvim-tree/nvim-web-devicons", "nvim-treesitter/nvim-treesitter-context"
    },
